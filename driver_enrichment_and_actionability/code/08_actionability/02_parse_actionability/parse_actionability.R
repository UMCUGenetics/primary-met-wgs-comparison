...
### Input
# Table of known curated actionable variants found in the literature. Curated by Hartwig medical foundation. Data request required.

### Output
# A cleaned up actionable variants table that should be compatible with parsed actionable variants from VCFs in step 8.1.
...
# def variables
actionable_variants_results_date <- '2021_12_03' # date name of your output folder you generated in step 8.1
...
actionability <- read_tsv(paste0(base_dir, '/data/external/actionable_variants.tsv.gz'))
...
split_cancerType <- data.frame(cancerType = c(rep('adenocarcinoma', 16),
                                              ...
                                              rep(c('lung cancer', 'lung carcinoma', 'Non small cell lung cancer', 'lung non-small cell carcinoma'), 2),
                                              rep(c('breast cancer',
                                                    'Breast cancer',
                                                    ...
                                                    'triple-receptor negative breast cancer'), 1),
                                              rep(c('breast cancer',
                                                    'Breast cancer',
                                                    'breast ductal carcinoma',
                                                    'breast carcinoma',
                                                    ...
                                                    'inflammatory breast carcinoma',
                                                    'breast papillary carcinoma',
                                                    'breast metaplastic carcinoma'), 4),
                                              rep('estrogen-receptor positive breast cancer', 2),
                                              rep('estrogen-receptor negative breast cancer', 2),
                                              rep('Her2-receptor negative breast cancer', 2),
                                              rep('Her2-receptor positive breast cancer', 2),
                               ...
                               cancer_type = c('Breast cancer', 'Colorectum carcinoma', 'Esophagus cancer', 'Stomach cancer', 
                                               ...
                                               rep('Lung adenocarcinoma', 4), rep('Lung squamous cell carcinoma', 4),
                                               rep('Breast carcinoma', 15), rep('Breast carcinoma_ER+/HER2-', 10),
                                               rep('Breast carcinoma_ER+/HER2+', 10), rep('Breast carcinoma_ER-/HER2+', 10), rep('Breast carcinoma_TNBC', 10),
                                               'Breast carcinoma_ER+/HER2-', 'Breast carcinoma_ER+/HER2+',
                                               'Breast carcinoma_ER-/HER2+', 'Breast carcinoma_TNBC',
                                               'Breast carcinoma_ER+/HER2-', 'Breast carcinoma_TNBC',
                                               'Breast carcinoma_ER+/HER2+', 'Breast carcinoma_ER-/HER2+',
                                               'Breast carcinoma_TNBC'))

# complete the table and reassign cancerType column based on cancer_type column
...
actionability <- actionability %>%
  mutate(cancerType = fct_collapse(cancerType,
                                   ...
                                   'Colorectal carcinoma' = c('colorectal cancer',
                                                              ...
                                                              'anal canal cancer'), 
                                   'Esophageal carcinoma' = c('esophagus adenocarcinoma',
                                                              'esophagus squamous cell carcinoma',
                                                              'esophageal cancer',
                                                              'esophageal carcinoma'),
                                   'Stomach carcinoma' = c('gastric adenocarcinoma',
                                   ...
                                   'Cervical carcinoma' = c('cervix carcinoma',
                                                            'cervical cancer',
                                                            'endocervical carcinoma',
                                                            'cervical adenocarcinoma',
                                                            'cervical squamous cell carcinoma'), 
                                   'Ovarian serous adenocarcinoma' = c('ovarian cancer',
                                   ...
                                   'Uterus carcinoma' = c('uterine cancer',
                                                          ...
                                                          'endometrioid ovary carcinoma'),
                                   'Upper respiratory tract carcinoma' = c('nasopharynx carcinoma',
                                                                           'hypopharynx cancer',
                                   ...
                                   'Kidney renal clear cell carcinoma' = c('kidney cancer',
                                                                           'renal cell carcinoma',
                                                                           'clear cell renal cell carcinoma',
                                                                           'renal carcinoma'),
                                   'Lung adenocarcinoma' = c('lung adenocarcinoma',
                                                             'lung non-squamous non-small cell carcinoma'),
                                   'Lung squamous cell carcinoma' = c('lung squamous cell carcinoma',
                                   ...
                                   'Thyroid carcinoma' = c('thyroid gland medullary carcinoma',
                                   ...
                                   'Bladder urothelial carcinoma' = c('urinary bladder cancer',
...
actionability <- actionability %>%
  ...
  filter(responseType %in% c('sensitive', 'predicted - sensitive', 'resistant', 'predicted - resistant')) %>%
  # only include Tier A (FDA approved) and B (late clinical)
...
actionabilitytt4 <- actionabilitytt3 %>%
  ...
  # replace all '-' in mutatted_variant with ' '
...
write_tsv(actionabilitytt4,
          file = paste0(base_dir, '/results/08_actionability/', actionable_variants_results_date, '/results/hartwig_actionability.tsv'))
