...
### Usage
# sbatch combine_driver_catalogs.sh -m <linx_catalog_manifest>
...
job_dir=$base_dir/results/02_combine_driver_catalogs/${current_date}/driver/scripts/jobs/; mkdir -p $job_dir; cd $job_dir

output_dir=$base_dir/results/02_combine_driver_catalogs/${current_date}/driver/results; mkdir -p $output_dir

# path to Rscript
R_SCRIPT=$base_dir/code/02_combine_driver_catalogs/combine_driver_catalogs.R
