...
### Usage
# sbatch 4_calculate_total_mutational_burden_from_matrices.sh -m <manifest_file>
...
job_dir=$base_dir/results/4_calculate_total_mutational_burden/${current_date}/scripts/jobs/; mkdir -p $job_dir; cd $job_dir

output_dir=$base_dir/results/4_calculate_total_mutational_burden/${current_date}/results/; mkdir -p $output_dir

# path to Rscript
R_SCRIPT=$base_dir/code/4_calculate_total_mutational_burden/calc_total_mutational_burden_from_matrices.R
