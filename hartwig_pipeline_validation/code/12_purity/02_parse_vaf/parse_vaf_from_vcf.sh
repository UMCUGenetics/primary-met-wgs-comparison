...
job_dir=$base_dir/results/12_purity/02_parse_vaf/${current_date}/scripts/jobs/; mkdir -p $job_dir; cd $job_dir

output_dir=$base_dir/results/12_purity/02_parse_vaf/${current_date}/results/; mkdir -p $output_dir
