...
vaf_input <- list.files(paste0(base_dir, '/results/12_purity/2_parse_vaf/', vaf_results_date, '/results/'),
                        full.names = T)
if (!exists('vaf')) {
...
# create output dir
output_dir <- paste0(output_dir, '/12_purity/3_plot_pure_samples/', current_date, '/results/plots')
