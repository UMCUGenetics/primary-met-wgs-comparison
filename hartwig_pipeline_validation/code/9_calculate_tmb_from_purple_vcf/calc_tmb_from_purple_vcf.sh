...
job_dir=$base_dir/results/9_calculate_tmb_from_purple_vcf/${current_date}/scripts/jobs/; mkdir -p $job_dir; cd $job_dir

output_dir=$base_dir/results/9_calculate_tmb_from_purple_vcf/${current_date}/results/; mkdir -p $output_dir

# path to the Rscript
R_SCRIPT=$base_dir/code/9_calculate_tmb_from_purple_vcf/calc_tmb_from_purple_vcf.R
