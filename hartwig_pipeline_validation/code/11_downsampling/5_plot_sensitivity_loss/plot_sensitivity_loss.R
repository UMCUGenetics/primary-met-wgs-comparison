...
pcawg_coverage <- read_tsv(file = paste0(base_dir, '/results/7_create_coverage_tables/', coverage_results_date, '/results/pcawg_coverage_info.tsv')) %>%
...
gz_file <- gzfile(paste0(base_dir, '/results/11_downsampling/2_extract_mutational_signatures_from_vcfs/', context_results_date, 
...
sv_tmb_init <- read_tsv(file = paste0(base_dir, '/results/11_downsampling/2_extract_mutational_signatures_from_vcfs/', context_results_date, 
...
# create output dir
output_dir <- paste0(output_dir, '/11_downsampling/5_plot_sensitivity_loss/', current_date, '/results/plots')
