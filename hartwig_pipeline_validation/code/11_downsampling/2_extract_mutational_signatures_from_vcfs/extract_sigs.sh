...
output_dir=$base_dir/results/11_downsampling/2_extract_mutational_signatures_from_vcfs/${current_date}/results/matrices; mkdir -p $output_dir

cd $job_dir

# Rscript path
R_SCRIPT=$base_dir/code/11_downsampling/2_extract_mutational_signatures_from_vcfs/extract_sigs.R
