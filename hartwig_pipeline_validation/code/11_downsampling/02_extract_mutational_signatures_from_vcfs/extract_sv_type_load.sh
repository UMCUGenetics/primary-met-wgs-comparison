...
output_dir=$base_dir/results/11_downsampling/02_extract_mutational_signatures_from_vcfs/${current_date}/results/matrices/sv; mkdir -p $output_dir

cd $job_dir

# Rscript path
R_SCRIPT=$base_dir/code/11_downsampling/02_extract_mutational_signatures_from_vcfs/extract_sv_type_load.R
