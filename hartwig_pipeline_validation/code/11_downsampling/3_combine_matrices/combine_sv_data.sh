...
# input dirs
input_dir=$base_dir/results/11_downsampling/2_extract_mutational_signatures_from_vcfs/${input_date}/results/matrices/sv

# create output dirs if they dont exist
output_file=$base_dir/results/11_downsampling/2_extract_mutational_signatures_from_vcfs/${input_date}/results/matrices/sv_contexts.txt
