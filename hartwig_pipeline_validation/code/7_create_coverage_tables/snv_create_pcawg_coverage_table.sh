...
job_dir=$base_dir/results/7_create_coverage_tables/${current_date}/scripts/jobs/; mkdir -p $job_dir; cd $job_dir

output_dir=$base_dir/results/7_create_coverage_tables/${current_date}/results; mkdir -p $output_dir

# path to Rscript
R_SCRIPT=$base_dir/code/7_create_coverage_tables/snv_create_pcawg_coverage_table.R
