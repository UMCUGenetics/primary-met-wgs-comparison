...
job_dir=$base_dir/results/04_calculate_cosine_similarity/${current_date}/scripts/jobs/; mkdir -p $job_dir; cd $job_dir

output_dir=$base_dir/results/04_calculate_cosine_similarity/${current_date}/results/; mkdir -p $output_dir

# path to R_SCRIPT
R_SCRIPT=$base_dir/code/04_calculate_cosine_similarity/calc_cosine_similarity_from_matrices.R
