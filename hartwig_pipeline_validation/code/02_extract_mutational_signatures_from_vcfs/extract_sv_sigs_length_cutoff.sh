...
job_dir=$base_dir/results/02_extract_mutational_signatures_from_vcfs/${current_date}/scripts/sv_jobs/; mkdir -p $job_dir
...
# Rscript path
R_SCRIPT=$sv_dir/code/02_extract_mutational_signatures_from_vcfs/extract_sv_sigs_length_cutoff.R
