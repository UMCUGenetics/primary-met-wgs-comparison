...
job_dir=$base_dir/results/2_extract_mutational_signatures_from_vcfs/${current_date}/scripts/smnv_jobs/; mkdir -p $job_dir
...
# Rscript path
R_SCRIPT=$base_dir/code/2_extract_mutational_signatures_from_vcfs/extract_sigs.R
...
sbatch $base_dir/code/2_extract_mutational_signatures_from_vcfs/extract_sv_sigs_length_cutoff.sh -l $length_cutoff
